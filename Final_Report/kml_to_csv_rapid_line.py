...
def process_coordinate_string(list_test):
    ...
    #print('list', ret.append(list_test[0]))
...
#    # There was a space in between <coordinates>" "-80.123...... hence the [1:]
    ...
    #ret.append(list_test[4])   #Company Name
    #ret.append(list_test[5])   #Company Name
    #ret.append(list_test[6])   #Company Name
    #ret.append(list_test[7])   #Company Name
    #ret.append(list_test[8])   #Company Name
    return ret
    ...
    with open(rootDir + kmlFile, encoding='utf8') as f:
        ...
        with open(rootDir + csvFile, 'w', newline='', encoding='utf8') as csvfile:
            ...
            for placemark in s.find_all('Placemark'):
                ...
                #for node in placemark.find('description'):
...
def main():
    ...
    kml_to_csv(abs_path, \
               '/Big_Data_Project/data/rapid_transit_line.kml',\
               '/Big_Data_Project/data/rapid_transit_line.csv')
